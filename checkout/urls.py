...
from .views import store_page, total_summary
...
urlpatterns = [
    ...
    path('order-confirmation/', show_order_confirmation, name='show_order_confirmation'),
    ...
    path('total-summary/', total_summary, name='total_summary'),
